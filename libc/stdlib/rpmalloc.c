// Taken from https://github.com/mjansson/rpmalloc/blob/develop/rpmalloc/rpmalloc.c (1.4.3)
...
static void
_rpmalloc_unmap_os(void* _address, size_t size, size_t _offset, size_t release) {
